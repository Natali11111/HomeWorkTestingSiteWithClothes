...
public class AccountBuilder {
    ...
    public Account build() {
        return new Account(gender, firstCustomerName, lastCustomerName, password, email,  day, month, year, firstName, lastName, company, address1, address2, city, state, postcode, country, homePhone, mobilePhone, alias);
    }
